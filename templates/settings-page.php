    ...
    <form method="post" action="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)) . 'direct-settings.php'); ?>">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description">Enter comma-separated list of approved ZIP codes</p>
                </td>
            </tr>
            <tr>
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <textarea name="ffb_blocked_ips" class="large-text" rows="3"><?php echo esc_html(is_array($blocked_ips) ? implode(', ', $blocked_ips) : $blocked_ips); ?></textarea>
        ...
        <table class="form-table">
            <tr>
                <th scope="row">Enable Diagnostic Mode</th>
                <td>
                    <input type="checkbox" name="ffb_diagnostic_mode" value="1" <?php checked('1', $diagnostic_mode); ?> />
                    <p class="description">When enabled, form submissions will be allowed even when geolocation fails or returns errors. <strong>Use only for troubleshooting!</strong></p>
                </td>
            </tr>
        </table>
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php endif; ?>
                    <form method="post" action="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)) . 'direct-settings.php'); ?>" style="display: inline-block; margin-left: 10px;">
                        ...
                        <button type="submit" class="button">Create/Recreate Table</button>
                    </form>
