<?php
/**
 * Database Fix for AQM Formidable Forms Spam Blocker
 * 
 * This file contains the updated log_access_attempt method that matches the database structure.
 * Replace the existing method with this one in the main plugin file.
 */
